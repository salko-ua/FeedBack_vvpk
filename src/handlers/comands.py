...
async def cmd_start(message: types.Message):
    ...
    text = (
        ...
        "4. Ваш відгук повинен бути інформативним, конструктивним та об'єктивним.\n"
        "5. Перший рядок відгуку - заголовок\n"
        "Дотримуйтесь цих правил і ваш відгук буде неодмінно опубліковано."
    )
